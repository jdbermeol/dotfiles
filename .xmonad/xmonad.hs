...
--
myWorkspaces    = ["1:code","2:web","3:msg","4:db","5:media","6:testing","7:im","8:web2","9:minimized"]
...
myTabConfig = defaultTheme {   activeBorderColor = "#7C7C7C"
                             , activeTextColor = "#CCFF00"
                             , activeColor = "#000000"
                             , inactiveBorderColor = "#7C7C7C"
                             , inactiveTextColor = "#EEEEEE"
                             , inactiveColor = "#000000" }
myLayout = smartBorders $ avoidStruts (tiled ||| Mirror tiled ||| tabbed shrinkText myTabConfig ||| Full ||| spiral (6/7))
  where
